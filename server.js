...
const db = mySQL.createConnection({
  host: process.env.DATABASE_PARKING_HOST,
  user: process.env.DATABASE_PARKING_USER,
  password: process.env.DATABASE_PARKING_PASSWORD,
  database: process.env.DATABASE_PARKING_NAME,
});
